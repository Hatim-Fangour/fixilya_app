...
/// Contains all dialogs used in Client Profile Page
class ClientProfileDialogs {
  /// Show Ultra Luxury Logout Dialog
  ...
  static Widget _buildAnimatedIcon(Animation<double> animation) {
  ...
  static Widget _buildTitle() {
    return ShaderMask(
      shaderCallback: (bounds) => LinearGradient(
        colors: [Color(0xFFFF6B6B), Color(0xFFC06C84)],
      ).createShader(bounds),
      child: Text(
        'Logout Account',
        style: TextStyle(
  ...
  static Widget _buildButtons(ClientProfileController controller) {
    return Row(
      children: [
        // Stay Button
        Expanded(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: AppColors.logoutButtonGradient,
              ),
              borderRadius: BorderRadius.circular(18),
              boxShadow: [
                BoxShadow(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () {
                  ...
                  controller.logout(); // Execute logout
                },
                child: Center(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
